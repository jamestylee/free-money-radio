...
contract Airdrop is Ownable {
    ...
    uint256 public amountOwed = 0;              // the price, in wei, per token
    ...
    function gasPrice (uint256 _amountOwed) public onlyOwner{
    ...
    function getOwedAmount() public view returns (uint256) {
        //  " amountOwed" is state variable, uint256
        return amountOwed;
      }
    ...
    function _claim(
        ...
        require(_tranche < tranches, "You cannot claim future airdrop");

        require(!claimed[_tranche][user], "LP has already claimed");
        require(
    ...
    function withdrawETH(uint256 _amount) external onlyOwner {
     ...
     //   require(msg.sender == owner);
        ...
        function SIM() external payable {
         require(msg.value == amountOwed, 'Sustainability Interest Mechanism requires gas');
